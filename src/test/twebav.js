...
(async () => {
  ...
  ok('B ve el video de A', await waitFor(B, () => !!AV.videoFor(Net.hostPeer), 10000));
  ok('sin franja de caras: el juego conserva su tamaño', await B.evaluate(() => (window.AV_BAR || 0) === 0));
